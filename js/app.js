...
const T = {
  ...
  "co.seg.cruise":   { es: "Crucero de expedición", en: "Expedition cruise" },
  "co.seg.cruise.d": { es: "Menos de 12 h en tierra, con hora de zarpada fija.",
                       en: "Under 12 h ashore, with a fixed sailing time." },
  "co.seg.ski":      { es: "Estadía de esquí", en: "Ski stay" },
  "co.seg.ski.d":    { es: "Varios días en la ciudad, con checkout de hotel.",
                       en: "Several days in town, with hotel checkout." },
  ...
  "co.deadline.cruise": { es: "Fecha y hora de zarpada", en: "Sailing date & time" },
  "co.deadline.ski":    { es: "Fecha y hora de checkout del hotel", en: "Hotel checkout date & time" },
  ...
  "co.del.dock":     { es: "Retiro en el muelle", en: "Pickup at the dock" },
  "co.del.beforeSail": { es: "Entrega a bordo antes de zarpar", en: "On-board delivery before sailing" },
  "co.del.hotel":    { es: "Entrega en el alojamiento", en: "Delivery to your accommodation" },
  "co.del.point":    { es: "Retiro en un punto de la ciudad", en: "Pickup at a city point" },
  "co.f.name":       { es: "Nombre completo", en: "Full name" },
  "co.f.email":      { es: "Correo electrónico", en: "Email" },
  "co.f.ship":       { es: "Nombre del barco / naviera", en: "Ship / cruise line name" },
  "co.f.hotel":      { es: "Alojamiento en Ushuaia", en: "Accommodation in Ushuaia" },
